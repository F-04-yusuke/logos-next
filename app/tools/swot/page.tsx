...
function BoxPanel({
  ...
  return (
    <div
      className={`bg-white ${colors.bg} border-t-4 ${colors.border} rounded-lg p-4 shadow-sm dark:shadow-lg flex flex-col h-full border-x border-b dark:border-transparent border-gray-200`}
    >
      <div className="flex justify-between items-center mb-3 border-b border-gray-200 dark:border-logos-border pb-2">
      ...
      <div className="flex-1 space-y-2 mb-3">
        {items.map((item, idx) => (
          <div
            key={idx}
            className="relative group flex items-start bg-gray-50 dark:bg-logos-bg p-2 rounded border border-gray-200 dark:border-logos-border focus-within:border-gray-400 dark:focus-within:border-gray-500 transition-colors mt-2"
          >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={saveSwot}
            disabled={isSaving}
            className="bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-logos-text font-bold py-1.5 px-4 rounded text-base transition-colors shadow-sm"
          >
            {isSaving ? "保存中..." : "保存する"}
          </button>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="border-b border-gray-200 dark:border-logos-border pb-4">
            ...
            <select
              ...
              className="bg-white dark:bg-logos-bg border border-gray-300 dark:border-logos-border rounded text-gray-900 dark:text-g-text text-base px-2 py-1 focus:outline-none focus:border-blue-500 font-bold cursor-pointer"
            >
              ...
              <div className="p-3 bg-logos-surface">
                <div className="flex gap-2 items-end">
                  <textarea
                    ...
                    className="flex-1 bg-white dark:bg-logos-bg border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-g-text text-base p-2.5 focus:outline-none focus:ring-1 focus:ring-blue-500 max-h-32 transition-shadow resize-none overflow-hidden"
                    onInput={(e) => {
                      const t = e.target as HTMLTextAreaElement;
                      t.style.height = "auto";
                      t.style.height = t.scrollHeight + "px";
