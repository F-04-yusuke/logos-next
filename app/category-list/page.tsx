        ...
        {categories.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {categories.map((parent) => (
              <div
                key={parent.id}
                className="bg-white dark:bg-[#1e1f20] shadow-sm rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden hover:shadow-md transition-shadow duration-200"
              >
                {/* 大分類ヘッダー */}
                <div className="bg-gray-50 dark:bg-[#131314] border-b border-gray-200 dark:border-gray-800 px-4 sm:px-5 py-4">
                  ...
                  >
                    <svg
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 text-gray-400 group-hover:text-blue-500 mr-3 transition-colors shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      ...
                      {parent.children.map((child) => (
                        <li key={child.id}>
                          ...
                          >
                            <svg
                              aria-hidden="true"
                              className="h-4 w-4 text-gray-300 dark:text-gray-600 group-hover:text-blue-400 mr-2 transition-colors shrink-0"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
