...
// ロゴコンポーネント（application-logo.blade.phpの忠実移植）
function AppLogo() {
  return (
    <div className="flex items-center gap-2">
      <svg viewBox="0 0 110 100" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto" aria-hidden="true">
      ...
      <span className="text-2xl font-black tracking-widest text-white mt-1">LOGOS</span>
    </div>
  );
}
