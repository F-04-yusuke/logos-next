        ...
        <div className="flex flex-col md:flex-row gap-4 min-h-[180px]">
          ...
          <div className="md:w-[35%] flex-shrink-0">
            ...
            {isDraft && !post.custom_thumbnail && !post.thumbnail_url ? (
              <div className="w-full aspect-video bg-logos-hover rounded-xl mb-2 flex flex-col items-center justify-center text-logos-sub border-2 border-dashed border-yellow-300 dark:border-yellow-700">
              ...
              >
                {post.thumbnail_url ? (
                  ...
                  <div className="w-full aspect-video bg-white dark:bg-logos-surface rounded-xl flex items-center justify-center border border-logos-border group-hover:border-indigo-300 dark:group-hover:border-logos-hover transition-colors">
                  ...
                  <div className="w-full aspect-video bg-black rounded-xl flex items-center justify-center border border-logos-border group-hover:border-gray-500 transition-colors">
                  ...
                  <div className="w-full aspect-video bg-logos-hover rounded-xl flex flex-col items-center justify-center text-logos-sub border border-logos-border group-hover:border-indigo-300 dark:group-hover:border-logos-hover transition-colors">
                    <svg
                      aria-hidden="true"
          ...
          <div className="md:w-[65%] flex flex-col justify-between">
            <div>
              ...
              {post.comment && (
                <div className="mt-2 break-all">
                  <p
                    ref={commentRef}
                    className={`text-lg text-gray-800 dark:text-g-text leading-relaxed${openComment ? "" : " line-clamp-3"}`}
                  >
                    {post.comment}
                  </p>
            ...
            {/* アクション行: 左=補足系ボタン / 右=like+削除 */}
            <div className="mt-2 flex items-center">
              {/* 左: 補足ありトグル or 補足を追加するボタン */}
              {post.supplement ? (
                <button
                  type="button"
