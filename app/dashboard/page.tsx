          ...
          <div className="p-4 sm:p-6">
            ...
            {activeTab === "posts" && (
              <div className="space-y-6">
                {posts.length > 0 && (
                  <p className="text-sm text-g-sub pl-2 border-l-2 border-gray-700">
                    {posts.length}件の投稿
                  </p>
                )}
                {posts.length === 0 ? (
                      ...
                      <div className="flex justify-between items-center px-2">
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="text-sm font-bold text-yellow-600 dark:text-yellow-400 hover:text-yellow-700 dark:hover:text-yellow-300 border border-yellow-300 dark:border-yellow-700 hover:border-yellow-400 py-1 px-3 rounded-md transition-colors duration-100 flex items-center gap-1 cursor-pointer"
                          >
                            <svg
                              aria-hidden="true"
                        ...
                        <div className="text-right">
                          <span className="text-sm font-bold text-gray-500 dark:text-g-sub">
                            🔗 投稿先:{" "}
                            <Link
                              href={`/topics/${post.topic.id}`}
            ...
            {activeTab === "analyses" && (
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <Link
                    href="/tools/tree"
                    className="inline-flex items-center text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded-md transition-colors duration-100 shadow-sm cursor-pointer"
                  >
                  ...
                  <Link
                    href="/tools/matrix"
                    className="inline-flex items-center text-sm font-bold text-white bg-purple-600 hover:bg-purple-700 px-3 py-1.5 rounded-md transition-colors duration-100 shadow-sm cursor-pointer"
                  >
                    <svg aria-hidden="true" className="h-3.5 w-3.5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <Link
                    href="/tools/swot"
                    className="inline-flex items-center text-sm font-bold text-white bg-green-600 hover:bg-green-700 px-3 py-1.5 rounded-md transition-colors duration-100 shadow-sm cursor-pointer"
                  >
                    <svg aria-hidden="true" className="h-3.5 w-3.5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                {analyses.length === 0 ? (
                  ...
                  <>
                    <p className="text-sm text-g-sub pl-2 border-l-2 border-gray-700 mb-1">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        <Link
                          ...
                          className="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 font-bold transition-colors duration-100 cursor-pointer"
                        >
                          編集
                        </Link>
                        ...
                        <button
                          ...
                          className="text-sm text-red-400 hover:text-red-600 font-bold transition-colors duration-100 cursor-pointer"
                        >
                          削除
                        </button>
                      </div>
