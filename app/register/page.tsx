  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center pt-6 sm:pt-0 bg-[#131314] px-4">
      ...
      <div className="mb-4">
        <Link
          href="/"
          className="hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg p-1 inline-block"
        >
        ...
        {!showDevForm && (
          <div>
            ...
            <p className="mt-5 text-[10px] text-gray-500 leading-relaxed text-left">
              登録することで、あなたはLOGOSの利用規約に同意し、当社のプライバシーポリシーを読み、それに同意したものとみなされます。
            </p>
