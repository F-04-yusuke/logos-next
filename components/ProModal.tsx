...
export function ProModal() {
  ...
  return (
    ...
    >
      <div
        className="bg-[#1e1f20] border border-gray-700 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="px-6 py-5">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">PROプランでできること</p>
